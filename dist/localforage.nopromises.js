/*!
    client-storage -- Fork of localForage with sessionStorage support
    Version 1.7.1
    https://feat7.github.io/client-storage
...
function isSessionStorageValid() {
    try {
        return typeof sessionStorage !== 'undefined' && 'setItem' in sessionStorage &&
...
function _getKeyPrefix$1(options, defaultConfig) {
    var keyPrefix = options.name + '/';
...
function _initStorage$3(options) {
    ...
    dbInfo.keyPrefix = _getKeyPrefix$1(options, self._defaultConfig);
    ...
    if (!options.name) {
        ...
        promise = new Promise$1(function (resolve) {
            if (!options.storeName) {
                ...
                resolve(_getKeyPrefix$1(options, self._defaultConfig));
            }
        }).then(function (keyPrefix) {
            for (var i = sessionStorage.length - 1; i >= 0; i--) {
                var key = sessionStorage.key(i);
...
var DefaultDriverOrder = [DefaultDrivers.INDEXEDDB._driver, DefaultDrivers.WEBSQL._driver, DefaultDrivers.LOCALSTORAGE._driver, DefaultDrivers.SESSIONSTORAGE._driver];
